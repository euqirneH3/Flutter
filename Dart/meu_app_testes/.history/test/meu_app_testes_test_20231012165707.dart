...
void main() {
  ...
  group("Calcula o valor do produto com desconto", () {
    ...
    valuesToTest.forEach((values, expected) {
      expect(app.calcularDesconto(values["valor"], values["desconto"], values["percentual"]), equals(850));
    });
  });

  mixin valuesToTest {
    static void forEach(Null Function(dynamic values, dynamic expected) param0) {}
  }
}